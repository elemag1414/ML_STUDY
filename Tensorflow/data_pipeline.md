...
<span style="font-family=Arial;">tf.data.Datasets</span> 객체는 **tf.data.Dataset.from_tensor()** 또는 **tf.data.Dataset.from_tensor_slices()** 를 사용하여 생성되며, 객체의 element들은 동일한 구조로 구성된다.
